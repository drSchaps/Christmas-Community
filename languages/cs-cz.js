...
module.exports.strings = {
  ...
  ADMIN_SETTINGS_CLEARDB_DESCRIPTION: '<b>Upozornění</b>: Tato volba <b>odstraní všechny vytvořené seznamy</b>! Zvažte vyvoření zálohy databáze, než budete pokračovat.',
  ADMIN_SETTINGS_CLEARDB_HEADER: 'Odstranit seznamy',
  ADMIN_SETTINGS_CLEARDB_SUCCESS: 'Všechny seznamy úspěšně vymazány',
  ADMIN_SETTINGS_HEADER: 'Nastavení',
  ...
  ADMIN_SETTINGS_USERS_EDIT_DEMOTE_SUCCESS: name => `Oprávnění správce bylo odebráno.`,
  ...
  ADMIN_SETTINGS_USERS_EDIT_PROMOTE_SUCCESS: name => `Oprávnění správce přidělena ${name}.`,
  ...
  ADMIN_USER_EDIT_DELETE_ADMIN: 'Uživatel je správce',
  ADMIN_USER_EDIT_DELETE_HEADER: 'Odstranit uživatele',
  ...
  ADMIN_USER_EDIT_PROMOTE: name => `Přidat oprávnění správce ${name}`,
  ...
  ADMIN_USER_EDIT_RESET_PASSWORD_HASLINK: 'Zde je odkaz pro obnovu hesla uživatele. ',
  ADMIN_USER_EDIT_RESET_PASSWORD_HEADER: 'Obnovit heslo',
  ADMIN_USER_EDIT_RESET_PASSWORD_LINK_CANCEL: 'Zneplatnit odkaz na obnovu hesla',
  ADMIN_USER_EDIT_RESET_PASSWORD_LINK_CREATE: 'Vytvořit odkaz na obnovu hesla',
  ADMIN_USER_EDIT_RESET_PASSWORD_LINK_REFRESH: 'Obnovit odkaz na obnovu hesla',
  ...
  WISHLIST_ADDED_BY_USER: addedBy => `Přidal: ${addedBy}`,
  WISHLIST_ADDED_BY: 'Přidal',
  ...
  WISHLIST_NAME: 'Položka',
  WISHLIST_NOTE: 'Poznámka',
  WISHLIST_OPTIONAL: 'Nepovinné',
  WISHLIST_PLEDGE_DUPLICATE: 'Tuto položku si již zarezervoval',
  ...
  WISHLIST_REFRESH_NO_URL: 'Položka nemá žádný odkaz.',
  ...
  WISHLIST_URL_LABEL: 'Jméno položky nebo odkaz na ni (odkazy na CZ obchody nejsou zatím podporované) <a href="/supported-sites">Podporované obchody</a>',
